...
export default function Fleet() {
  return (
    <section>
        <div className='fleet-hero' style={{backgroundImage: `url(${FleetPageAdImg})`}}>
            <div className="fleet-ad-content">
                <h1 className="fleet-ad-heading">Experience WHN's Fleet Selection</h1>
                <p className="fleet-ad-text">Find Your Perfect Drive</p>
            </div>
        </div>
